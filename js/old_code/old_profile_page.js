...
window.onload = function() {
  function populateDoc(userNumber) {
    ...
    if (! (users[userNumber].url1 === "url1")) {
      ...
      $(".user-"+ userNumber +"--url-1").attr("href", users[userNumber].url1);
    ...
    if (! (users[userNumber].url2 === "url2")) {
      ...
      $(".user-"+ userNumber +"--url-2").attr("href", users[userNumber].url2);
      $(".user-"+ userNumber +"--url-2").attr("target", `_blank`);
    ...
    if (! (users[userNumber].url3 === "url3")) {
      ...
      $(".user-"+ userNumber +"--url-3").attr("href", users[userNumber].url3);
      $(".user-"+ userNumber +"--url-3").attr("target", `_blank`);
